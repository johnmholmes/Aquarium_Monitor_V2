/*
  Version 5 is work in progress to sort out the reconnection if either wifi or mqtt is not connected.

  version 4 seemed to be unable use the mqttClient.loop() due to the if statement.
*/
...
void connectToMqtt() {
  while (!mqttClient.connected()) {
    ...
    if (mqttClient.connect("atoClientV5")) {
